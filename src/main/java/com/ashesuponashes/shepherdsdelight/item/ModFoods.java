...
public class ModFoods {
    ...
    public static final FoodProperties COD_SUSHI_WRAP = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.9F).build();
    ...
    public static final FoodProperties SAUSAGE_WARTS_PASTA = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.7F).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), MEDIUM_DURATION, 0), 1.0F).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 800, 0), 1.0F).build();
    public static final FoodProperties HOGLIN_WRAP = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.6F).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 800, 0), 1.0F).build();
    ...
    public static final FoodProperties FIRESTARTER_STEW = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.8F).effect(() -> new MobEffectInstance(ModEffects.COMFORT.get(), MEDIUM_DURATION, 0), 1.0F).effect(new MobEffectInstance(MobEffects.REGENERATION, 200, 0), 1.0F).build();
    public static final FoodProperties GHAST_SUSHI_WRAP = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.5F).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 900, 0), 1.0F).build();
    ...
    public static final FoodProperties CHARQUE_CACTUS_ROAST = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.9F).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), LONG_DURATION, 0), 1.0F).build();
    public static final FoodProperties STEAK_PLATTER = (new FoodProperties.Builder()).nutrition(14).saturationMod(0.9F).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), LONG_DURATION, 0), 1.0F).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 800, 0), 1.0F).build();
    public static final FoodProperties STEAMED_SANDWICH = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.8F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, MEDIUM_DURATION, 0), 1.0F).build();
    public static final FoodProperties RICE_BURGER = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.8F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, BRIEF_DURATION, 0), 1.0F).build();
    public static final FoodProperties SOUR_BURGER = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.8F).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, SHORT_DURATION, 0), 1.0F).build();
    ...
    public static final FoodProperties SHROOMLIGHT_SANDWICH = (new FoodProperties.Builder()).nutrition(8).saturationMod(0.6F).effect(new MobEffectInstance(MobEffects.CONFUSION, 150, 0), 1.0F).build();
    public static final FoodProperties CHEESE_WEDGE = (new FoodProperties.Builder().fast()).nutrition(3).saturationMod(0.5F).build();
    public static final FoodProperties MOLTEN_CHEESE = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.5F).build();
    public static final FoodProperties GRILLED_CHEESE = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.7F).build();
    public static final FoodProperties CHEESESTEAK = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.8F).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), SHORT_DURATION, 0), 1.0F).build();
