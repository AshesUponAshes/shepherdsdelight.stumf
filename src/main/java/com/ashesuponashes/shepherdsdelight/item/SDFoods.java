...
public class SDFoods {
    ...
    public static final FoodProperties RAW_CHARQUE = (new FoodProperties.Builder().meat()).nutrition(2).saturationMod(0.5f).build();
    ...
    public static final FoodProperties GHAST_TENDRIL = (new FoodProperties.Builder().meat()).nutrition(7).saturationMod(0.6F).effect(new MobEffectInstance(MobEffects.CONFUSION, 240, 0), 0.4F).build();
    public static final FoodProperties GHAST_FILLET = (new FoodProperties.Builder().meat().fast()).nutrition(3).saturationMod(0.3F).build();
    ...
    public static final FoodProperties RAW_EQUIN_RIBS = (new FoodProperties.Builder().meat()).nutrition(6).saturationMod(0.4F).build();
    ...
    public static final FoodProperties FUGU = (new FoodProperties.Builder().meat()).nutrition(5).saturationMod(0.6f).build();
    public static final FoodProperties CURED_PUFFERFISH = (new FoodProperties.Builder().meat()).nutrition(2).saturationMod(0.1f).build();
    public static final FoodProperties CUT_FUGU = (new FoodProperties.Builder().meat()).nutrition(2).saturationMod(0.3f).build();
    public static final FoodProperties CURED_PUFFERFISH_CUT = (new FoodProperties.Builder().meat()).nutrition(1).saturationMod(0.1f).effect(new MobEffectInstance(MobEffects.HUNGER, 150, 1), 1.0F).build();
    ...
    public static final FoodProperties COOKED_MEATLOAF = (new FoodProperties.Builder()).nutrition(9).saturationMod(0.7F).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), SHORT_DURATION, 0), 1.0F).build();
    ...
    public static final FoodProperties WEEPING_LOAF = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.5F).effect(new MobEffectInstance(MobEffects.CONFUSION, 240, 0), 0.3F).build();
    public static final FoodProperties RICE_CAKE = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.5F).build();
    public static final FoodProperties SAUCY_SAUSAGE = (new FoodProperties.Builder().meat()).nutrition(10).saturationMod(0.6f).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 800, 0), 1.0F).build();

    public static final FoodProperties SHROOMLIGHT_NUGGETS = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.6F).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), LONG_DURATION, 0), 1.0F).effect(new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 0.3F).build();
    public static final FoodProperties SAUSAGE_STEW = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.6F).effect(() -> new MobEffectInstance(ModEffects.COMFORT.get(), MEDIUM_DURATION, 0), 1.0F).build();
    public static final FoodProperties SAUSAGE_WARTS_PASTA = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.7F).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), LONG_DURATION, 0), 1.0F).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 800, 0), 1.0F).build();
    public static final FoodProperties GHAST_SUSHI_WRAP = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.5F).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 1600, 0), 1.0F).build();
    public static final FoodProperties TWISTED_CHOWDER = (new FoodProperties.Builder()).nutrition(8).saturationMod(0.5F).effect(() -> new MobEffectInstance(ModEffects.COMFORT.get(), SHORT_DURATION, 0), 1.0F).effect(new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 0.5F).build();
    ...
    public static final FoodProperties BONE_BROTH = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.4F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, SHORT_DURATION, 0), 1.0F).build();
    ...
    public static final FoodProperties FERMENTED_SAUSAGE = (new FoodProperties.Builder().meat()).nutrition(5).saturationMod(0.4f).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 100, 0), 1.0F).build();
    ...
    public static final FoodProperties LLAMA_BURGER = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.7F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 200, 0), 0.8F).build();
    public static final FoodProperties SHROOMLIGHT_SANDWICH = (new FoodProperties.Builder()).nutrition(8).saturationMod(0.6F).effect(new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 0.8F).build();
    public static final FoodProperties CHEESESTEAK = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.8F).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), 200, 0), 0.8F).build();
    public static final FoodProperties STEAMED_SANDWICH = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.8F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 200, 0), 0.8F).build();
    ...
    public static final FoodProperties SOUR_BURGER = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.8F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 0), 0.8F).build();

    public static final FoodProperties NETHER_STIR_FRY = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.9F).effect(() -> new MobEffectInstance(ModEffects.COMFORT.get(), LONG_DURATION, 0), 1.0F).build();
    public static final FoodProperties STRIDER_SANDWICH = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.8F).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 200, 0), 0.8F).build();
    public static final FoodProperties HOGLIN_WRAP = (new FoodProperties.Builder()).nutrition(12).saturationMod(0.6F).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 0), 0.8F).build();
